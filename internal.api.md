...
## new reactiveProperty(defaultValue)&nbsp;&nbsp;<sub><i>Anywhere</i></sub> [reactiveProperty] ##
...
## reactiveProperty.value&nbsp;&nbsp;<sub><i>Anywhere</i></sub> [reactiveProperty.value] ##
...
## reactiveProperty.get()&nbsp;&nbsp;<sub><i>Anywhere</i></sub> [reactiveProperty.get] ##
Usage:
```js
